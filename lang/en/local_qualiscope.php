...
$string['licence_status_missing'] = 'No licence key entered — running in free plan.';
$string['licence_status_ok'] = 'Licence active, valid until {$a->expiry}.';
$string['licence_status_wrong_site'] = 'Licence key is bound to another site.';
$string['licencekey'] = 'Licence key';
$string['licencekey_desc'] = 'Paste the licence key delivered for this site. The free plan allows up to {$a->max} distinct courses to be audited; an annual licence removes the limit.';
$string['licencerequired'] = 'This course is beyond the free plan limit. An additional licence is required to audit more courses.';
...
$string['privacy:metadata:actions:title'] = 'Action title';
$string['privacy:metadata:annotation'] = 'Evidence annotation';
$string['privacy:metadata:campaigns'] = 'Audit campaigns created by the user';
$string['privacy:metadata:campaigns:name'] = 'Campaign name';
$string['privacy:metadata:evidences'] = 'Evidence uploaded by the user';
$string['privacy:metadata:evidences:title'] = 'Evidence title';
$string['privacy:metadata:responsible'] = 'Action responsible';
