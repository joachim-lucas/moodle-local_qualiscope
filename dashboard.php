...
foreach ($criteria as &$entry) {
    ...
    $entry['title'] = $entry['criteria']->title;
    $entry['shorttitle'] = core_text::strlen($entry['title']) > 60 ? core_text::substr($entry['title'], 0, 60) . '…' : $entry['title'];
